...
class SystemController extends Controller
{
    ...
    public function choose_shipping_address(Request $request)
    {
        ...
        if (isset($shipping['save_address']) && $shipping['save_address'] == 'on') {
            ...
            if ($shipping['contact_person_name'] == null || $shipping['address'] == null || $shipping['city'] == null || $shipping['country'] == null || $shipping['phone'] == null || $shipping['contact_person_name'] == null || $shipping['email'] == null) {
                return response()->json([
                    'errors' => ['']
                ], 403);
            }
            ...
            $address_id = DB::table('shipping_addresses')->insertGetId([
                ...
                'zip' => $shipping['zip'],
                'phone' => $shipping['country_phone'].''.$shipping['phone'],
        ...
        if (isset($shipping['order_note'])) {
            session()->put('order_note', $shipping['order_note']);
