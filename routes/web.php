...
//     Route::get('/', 'WebController@home')->name('home');
    Route::get('/', 'WebController@contacts')->name('home');
    ...
    Route::group(['middleware'=>['customer']], function () {
        ...
        Route::get('checkout-complete-view', 'WebController@checkout_complete_view')->name('checkout-complete-view')->middleware('customer');
    ...
    Route::get('shipping-policy', 'WebController@shippingAndReturnPolicy')->name('shipping-policy');
    ...
    //Blog
    Route::get('blog', 'WebController@getBlog')->name('blog');
...
Route::group(['prefix' => 'cart', 'as' => 'cart.', 'namespace' => 'Web'], function () {
    ...
    Route::post('remove-without-login', 'CartController@removeFromCartWithoutLogin')->name('remove-without-login');
...
Route::get('/verification-code', function (){
    return view('web-views.verification-code');
});
