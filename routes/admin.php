...
Route::group(['namespace' => 'Admin', 'prefix' => 'admin', 'as' => 'admin.'], function () {
    ...
    Route::group(['middleware' => ['admin']], function () {
        ...
        Route::group(['prefix' => 'blog', 'as' => 'blog.','middleware'=>['module:product_management']], function () {
            ...
            Route::get('fetch', 'BlogController@fetch')->name('fetch');
            ...
            Route::get('status/{id}/{blog_status}', 'BlogController@status')->name('status');
        });
        ...
        Route::group(['prefix' => 'product', 'as' => 'product.','middleware'=>['module:product_management']], function () {
            ...
            Route::get('remove-image-variation', 'ProductController@remove_image_variation')->name('remove-image-variation');
            ...
            Route::post('color-combination', 'ProductController@color_combination')->name('color-combination');
        ...
        Route::group(['prefix' => 'business-settings', 'as' => 'business-settings.','middleware'=>['module:business_settings']], function () {
            ...
            Route::post('shipping-policy', 'BusinessSettingsController@updateShippingPolicy')->name('shipping-policy');
...
//                Route::get('app', 'LanguageController@index_app')->name('index-app');
        ...
        Route::group(['prefix' => 'pos', 'as' => 'pos.','middleware'=>['module:pos_management']], function () {
            ...
            Route::post('return', 'POSController@return_product')->name('return');
