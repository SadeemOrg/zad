...
Route::group(['namespace' => 'Customer', 'prefix' => 'customer', 'as' => 'customer.'], function () {
    ...
    Route::group([], function () {
        ...
        Route::group(['prefix' => 'payments', 'as' => 'payments.'],function () {
            Route::post('get-iframe', [PaymentController::class, 'getIframe'])->name('getIframe');
            Route::get('success', [PaymentController::class, 'success'])->name('cardcomSuccess');
            Route::get('error', [PaymentController::class, 'error'])->name('cardcomError');
            Route::get('indicator', [PaymentController::class, 'indicator'])->name('cardcomIndicator');
        });
    });
});
