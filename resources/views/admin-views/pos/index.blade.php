        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">{{\App\CPU\translate('return_product')}}</h5>
                    <button id="return_close" type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                <div class="modal-body">
                    <form action="{{route('admin.pos.return')}}" id='return_product_fornm' method="post" class="row">
                        @csrf
                        <div class="form-group col-12">
                            <label class="input-label" for="">{{\App\CPU\translate('SKU')}}</label>
                            <input type="text" class="form-control" name="sku" min="0" step="0.01" 
                                    value=""
                                    >
                        </div>

                        <div class="form-group col-12">
                            <label class="input-label" for="">{{\App\CPU\translate('Number_order')}}</label>
                            <input type="number" class="form-control" name="number_order" min="0" step="0.01" 
                                    value=""
                                    >
                        </div>
                        
                        <div class="form-group col-12">
                            <label class="input-label" for="">{{\App\CPU\translate('Quantity')}}</label>
                            <input type="number" class="form-control" name="quantity" min="0" 
                                    >
                        </div>
                        <div class="form-group col-12">
                            <button class="btn btn-primary" id="return_product_complete" type="submit">{{\App\CPU\translate('Return')}}</button>
                        </div>
                    </form>
                </div>
            </div>
			...
			<div class="row">
				...
				<div class="col-md-4 padding-y-sm mt-2">
                    <div class="card pr-1 pl-1">
                            ...
                            <div class="row">
                                <div class="form-group mt-1 col-12 col-lg-4 mb-0">
                                ...
                                <div class="form-group mt-1 col-12 col-lg-4 mb-0">
                                    <a id="bt_return" class="w-100 d-inline-block btn btn-danger rounded" data-toggle="modal" data-target="#returnModal">
                                        {{ \App\CPU\translate('return')}}
                                    </a>
                                </div>
                            </div>
                            <div class="row mt-2">
