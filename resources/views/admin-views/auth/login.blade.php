                            ...
                            @else
                                <div class="row p-2">
                                    <div class="col-6 pr-0">
                                        <input type="text" class="form-control form-control-lg" name="builder"
                                               value="{{env('APP_MODE')=='live'?"":session('builder')}}"
                                               id="builder" placeholder="{{\App\CPU\translate('Enter recaptcha value')}}" style="border: none" autocomplete="off">
                                    </div>
                                    <div class="col-6" style="background-color: #FFFFFF; border-radius: 5px;">
                                        <img src="<?php echo $builder->inline(); ?>" style="width: 100%; border-radius: 4px;"/>
                                    </div>
                                </div>
                            @endif
