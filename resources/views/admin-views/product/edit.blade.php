                                        ...
                                        <select
                                            ...
                                            @foreach (\App\Model\Color::orderBy('name', 'asc')->get() as $key => $color)
                                                <option
                                                    ...
                                                    value={{ $color->code }} {{in_array($color->code,($product['code_colors']))?'selected':''}}>
                                                    {{$color['name']}}
                                                </option>
                                            @endforeach
                                        </select>
                            ...
                            <div class="form-group">
                                <div class="row">
                                    <div class="col-md-6">
                                        ...
                                        @php($dic = $product->discount_type == "percent" ? ($product->price / 100) * $product->discount: $product->discount )
                                        <input type="number" min="0" step="0.01"
                                               placeholder="{{\App\CPU\translate('price') }}"
                                               name="price_with_tax" class="form-control"
                                               value={{\App\CPU\Convert::default(($product->unit_price*1.17+$dic))}} required>
                                    </div>
                                   ...
                                   {{--<div class="col-md-4">
                                        ...
                                        <input type="number" min="0" step="0.01"
                                               ...
                                               value={{\App\CPU\Convert::default($product->unit_price)}} required readonly>
                                    </div>--}}
                                   ...
                                   {{--<div class="col-md-5">
                                    ...
                                    <input type="hidden" min="0" value="17" step="0.01"
                                               placeholder="{{\App\CPU\translate('Tax')}}" name="tax"
                                               value="{{old('tax')}}"
                                               class="form-control">
                                        <input name="tax_type" value="percent" style="display: none">
                                    ...
                                    <div class="col-12 pt-4 color_combination" id="color_combination">
                                        @include('admin-views.product.partials._edit_color_combinations',['combinations'=>$product['colors']])
                                    </div>
                                    <div class="col-12 pt-4 sku_combination" id="sku_combination">
                                        @include('admin-views.product.partials._edit_sku_combinations',['combinations'=>json_decode($product['variation'],true,),'discount'=>$product->discount,'discount_type'=>$product->discount_type])
                                    </div>
