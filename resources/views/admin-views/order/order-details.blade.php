                                    ...
                                    <div class="media-body">
                                        ...
                                        <div class="row">
                                            <div class="col-md-4 mb-3 mb-md-0 product-name">
                                                ...
                                                <?php 
                                                $d = json_decode($detail->product['variation']);
                                                $d_array = json_encode($d);
                                                $d = collect($d)->where('type',$detail['variant'])->values();
                                                $sku = ""; 
                                                ...
                                                <div class="font-size-sm text-body d-flex flex-column">

                                                    <span class="font-weight-bold">{{$detail['variant']}}</span>
                                                    <span class="font-weight-bold">sku:{{$sku}}</span>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col col-md-2 align-self-center text-right  ">
                                                @php($subtotal=($detail['price']*$detail->qty)+$detail['tax'])
...
@push('script_2')
    ...
    <script>
        ...
        function initializegLocationMap() {
            var map = null;
            var myLatlng = new google.maps.LatLng({{$shipping_address->latitude??180}}, {{$shipping_address->longitude??-180}});
