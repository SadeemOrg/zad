                            ...
                            @endif
                                ...
                                @if($order->customer)
                                    <a class="text-body text-capitalize"
                                       href="{{route('admin.orders.details',['id'=>$order['id']])}}">{{$shipping_address? $shipping_address->contact_person_name !="" ? $shipping_address->contact_person_name : $order->customer['f_name'].' '.$order->customer['l_name'] : $order->customer['f_name'].' '.$order->customer['l_name']}}</a>
                                @else
