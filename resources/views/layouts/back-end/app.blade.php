...
<head>
    ...
    <!-- <script type="text/javascript" src="{{asset('assets/back-end')}}/vendor/ckeditor/ckeditor/config.js?t=M2GA"></script> -->
...
<script>
    ...
    $(document).on('ready', function () {
        ...
        var contectEditors = document.getElementsByName("content[]");
        ...
        if(contectEditors != null && typeof(contectEditors) != 'undefined') {
