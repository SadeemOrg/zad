                ...
                <div class="navbar-vertical-content mt-2">
                    ...
                    <!--order management ends-->
                        ...
                        @if(\App\CPU\Helpers::module_permission_check('product_management'))
                           ...
                           <li class="navbar-vertical-aside-has-menu {{(Request::is('admin/blog*') ||Request::is('admin/blog*')) ?'active':''}}">
                                <a class="js-navbar-vertical-aside-menu-link nav-link nav-link-toggle"
                                   href="javascript:">
                                    <i class="tio-filter-list nav-icon"></i>
                                    <span class="navbar-vertical-aside-mini-mode-hidden-elements text-truncate">
                                ...
                                <ul class="js-navbar-vertical-aside-submenu nav nav-sub"
                                    style="display: {{(Request::is('admin/blog*') ||Request::is('admin/blog*'))?'block':''}}">
                                    <li class="nav-item {{Request::is('admin/blog/list')?'active':''}}">
                                        <a class="nav-link " href="{{route('admin.blog.list')}}">
                                            <span class="tio-circle nav-indicator-icon"></span>
                                            <span class="text-truncate">{{\App\CPU\translate('blog')}}</span>
                                        </a>
                                ...
                                <ul class="js-navbar-vertical-aside-submenu nav nav-sub"
                                    ...
                                    <li class="nav-item {{Request::is('admin/business-settings/shipping-policy')?'active':''}}">
                                        <a class="nav-link" href="{{route('admin.business-settings.shipping-policy')}}">
                                            <span class="tio-circle nav-indicator-icon"></span>
                                            <span class="text-truncate">
                                              {{\App\CPU\translate('shipping_and_return_policy')}}
                                            </span>
                                        </a>
                                    </li>
