...
@section('content')
   ...
   <div class="relative max-w-xl mx-auto px-4 sm:px-6 lg:px-8 lg:max-w-7xl rtl">
      <div class="relative mb-10 text-right">
         <h2 class="text-[28px] leading-8 text-right pt-20 text-[#201A3C] sm:text-[28px]"> الشروط والاحكام</h2>
         <p dir="rtl" class="mt-7 mb-8 text-right font-shamelnormal text-[#201A3C] text-[16px]">  {!! $terms_condition['value'] !!} </p>
